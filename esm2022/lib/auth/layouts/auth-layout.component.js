...
export class RsAuthLayoutComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: RsAuthLayoutComponent, selectors: [["rc-auth-layout"]], ngContentSelectors: _c0, decls: 4, vars: 0, consts: [[1, "col"], [1, "mb-5"]], template: function RsAuthLayoutComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵprojectionDef();
            i0.ɵɵelementStart(0, "rc-centered-page")(1, "div", 0)(2, "rc-card", 1);
            i0.ɵɵprojection(3);
            i0.ɵɵelementEnd()()();
        } }, dependencies: [RcCenteredPageComponent, RcCardComponent], encapsulation: 2 });
}
