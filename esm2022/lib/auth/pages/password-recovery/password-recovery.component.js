...
export class RcPasswordRecoveryComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: RcPasswordRecoveryComponent, selectors: [["rc-password-recovery"]], inputs: { config: "config", state: "state" }, outputs: { requestReset: "requestReset", submitNewPassword: "submitNewPassword" }, decls: 16, vars: 12, consts: [[1, "w-100p", "col", "justify-center", "align-items-center", "mt-3", "mb-2"], [3, "width", "src", "alt"], [1, "p-2"], [1, "mt-1", "row", "justify-center", "align-item-center"], ["vclForm", "", 1, "form", 3, "formGroup"], [1, "text-center", "mt-3"], [1, "error", "text-center", "mt-3"], ["vclForm", "", 1, "form", 3, "ngSubmit", "formGroup"], ["vclInput", "", "formControlName", "identifier"], [1, "row"], ["vcl-button", "", "type", "submit", 1, "w-100p", "emphasized", 3, "disabled"], ["vclInput", "", "formControlName", "password"], ["vclInput", "", "formControlName", "confirmPassword"]], template: function RcPasswordRecoveryComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵconditionalCreate(15, RcPasswordRecoveryComponent_Conditional_15_Template, 4, 5, "p", 5);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵadvance(2);
