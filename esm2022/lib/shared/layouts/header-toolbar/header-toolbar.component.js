...
function RcHeaderToolbarComponent_Conditional_0_ng_template_16_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵconditionalCreate(1, RcHeaderToolbarComponent_Conditional_0_ng_template_16_Conditional_1_Template, 4, 3, "vcl-select-list-item", 20);
    i0.ɵɵconditionalCreate(2, RcHeaderToolbarComponent_Conditional_0_ng_template_16_Conditional_2_Template, 4, 3, "vcl-select-list-item", 21);
    i0.ɵɵconditionalCreate(3, RcHeaderToolbarComponent_Conditional_0_ng_template_16_Conditional_3_Template, 4, 3, "vcl-select-list-item", 22);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r4 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance();
