...
function RcHeaderToolbarComponent_Conditional_0_ng_template_14_For_5_Template(rf, ctx) { if (rf & 1) {
...
function RcHeaderToolbarComponent_Conditional_0_ng_template_14_Template(rf, ctx) { if (rf & 1) {
    const _r4 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 13)(1, "vcl-input-field", 14)(2, "input", 15);
    i0.ɵɵtwoWayListener("ngModelChange", function RcHeaderToolbarComponent_Conditional_0_ng_template_14_Template_input_ngModelChange_2_listener($event) { i0.ɵɵrestoreView(_r4); const ctx_r4 = i0.ɵɵnextContext(2); i0.ɵɵtwoWayBindingSet(ctx_r4.searchTerm, $event) || (ctx_r4.searchTerm = $event); return i0.ɵɵresetView($event); });
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(3, "vcl-select-list", 16);
    i0.ɵɵlistener("valueChange", function RcHeaderToolbarComponent_Conditional_0_ng_template_14_Template_vcl_select_list_valueChange_3_listener($event) { i0.ɵɵrestoreView(_r4); i0.ɵɵnextContext(); const templatePopoverOrganization_r2 = i0.ɵɵreference(15); const ctx_r4 = i0.ɵɵnextContext(); ctx_r4.onSelectOrganization($event); return i0.ɵɵresetView(templatePopoverOrganization_r2.close()); });
    i0.ɵɵrepeaterCreate(4, RcHeaderToolbarComponent_Conditional_0_ng_template_14_For_5_Template, 3, 2, "vcl-select-list-item", 17, i0.ɵɵrepeaterTrackByIndex);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
function RcHeaderToolbarComponent_Conditional_0_ng_template_16_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1(" ", "rs-ui.header.account.profileLabel", " ");
} }
function RcHeaderToolbarComponent_Conditional_0_ng_template_16_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1(" ", "rs-ui.header.account.preferencesLabel", " ");
} }
function RcHeaderToolbarComponent_Conditional_0_ng_template_16_Conditional_3_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1(" ", "rs-ui.header.account.signOutLabel", " ");
} }
function RcHeaderToolbarComponent_Conditional_0_ng_template_16_Template(rf, ctx) { if (rf & 1) {
    const _r7 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "vcl-select-list", 19);
    i0.ɵɵlistener("valueChange", function RcHeaderToolbarComponent_Conditional_0_ng_template_16_Template_vcl_select_list_valueChange_0_listener($event) { i0.ɵɵrestoreView(_r7); i0.ɵɵnextContext(); const templatePopoverAccount_r3 = i0.ɵɵreference(17); const ctx_r4 = i0.ɵɵnextContext(); ctx_r4.onAccountItemSelected($event); return i0.ɵɵresetView(templatePopoverAccount_r3.close()); });
    i0.ɵɵconditionalCreate(1, RcHeaderToolbarComponent_Conditional_0_ng_template_16_Conditional_1_Template, 3, 1, "vcl-select-list-item", 20);
    i0.ɵɵconditionalCreate(2, RcHeaderToolbarComponent_Conditional_0_ng_template_16_Conditional_2_Template, 3, 1, "vcl-select-list-item", 21);
    i0.ɵɵconditionalCreate(3, RcHeaderToolbarComponent_Conditional_0_ng_template_16_Conditional_3_Template, 3, 1, "vcl-select-list-item", 22);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r4 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance();
...
function RcHeaderToolbarComponent_Conditional_0_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("click", function RcHeaderToolbarComponent_Conditional_0_Template_button_click_3_listener() { i0.ɵɵrestoreView(_r1); const templatePopoverOrganization_r2 = i0.ɵɵreference(15); return i0.ɵɵresetView(templatePopoverOrganization_r2.toggle()); });
    i0.ɵɵelement(4, "vcl-icon", 6);
    i0.ɵɵtext(5);
    i0.ɵɵelement(6, "vcl-icon", 7);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(7, "span", 4, 1)(9, "button", 8);
    i0.ɵɵlistener("click", function RcHeaderToolbarComponent_Conditional_0_Template_button_click_9_listener() { i0.ɵɵrestoreView(_r1); const templatePopoverAccount_r3 = i0.ɵɵreference(17); return i0.ɵɵresetView(templatePopoverAccount_r3.toggle()); });
    i0.ɵɵelementStart(10, "vcl-icogram");
    i0.ɵɵelement(11, "vcl-icon", 9);
    i0.ɵɵtext(12);
    i0.ɵɵelement(13, "vcl-icon", 10);
    i0.ɵɵelementEnd()()()();
    i0.ɵɵtemplate(14, RcHeaderToolbarComponent_Conditional_0_ng_template_14_Template, 6, 1, "ng-template", 11, 2, i0.ɵɵtemplateRefExtractor)(16, RcHeaderToolbarComponent_Conditional_0_ng_template_16_Template, 4, 3, "ng-template", 12, 3, i0.ɵɵtemplateRefExtractor);
} if (rf & 2) {
    const popoverOrganizationTarget_r8 = i0.ɵɵreference(2);
    const popoverAccountTarget_r9 = i0.ɵɵreference(8);
    const ctx_r4 = i0.ɵɵnextContext();
    i0.ɵɵadvance(3);
    i0.ɵɵproperty("selectable", true);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1(" ", (ctx_r4.selectedOrganization == null ? null : ctx_r4.selectedOrganization.name) || "rs-ui.header.org.selectPlaceholder", " ");
    i0.ɵɵadvance(4);
    i0.ɵɵproperty("selectable", true);
    i0.ɵɵadvance(3);
...
export class RcHeaderToolbarComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: RcHeaderToolbarComponent, selectors: [["rc-header-toolbar"]], hostVars: 2, hostBindings: function RcHeaderToolbarComponent_HostBindings(rf, ctx) { if (rf & 2) {
            ...
            i0.ɵɵconditionalCreate(0, RcHeaderToolbarComponent_Conditional_0_Template, 18, 10);
        } if (rf & 2) {
            ...
            VCLIcogramModule,
            VCLInputModule, i2.InputDirective, i2.InputFieldComponent], encapsulation: 2, changeDetection: 0 });
}
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(RcHeaderToolbarComponent, { className: "RcHeaderToolbarComponent", filePath: "lib/shared/layouts/header-toolbar/header-toolbar.component.ts", lineNumber: 43 }); })();
